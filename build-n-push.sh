...
# PHP 8.1 - latest
docker buildx build --platform linux/amd64,linux/arm64 -f Dockerfile -t zouloux/docker-debian-apache-php:8.1 -t zouloux/docker-debian-apache-php:latest --build-arg IMAGE_PHP_VERSION=8.1 --push .
...
# PHP 8.0 - ( legacy )
docker buildx build --platform linux/amd64,linux/arm64 -f Dockerfile -t zouloux/docker-debian-apache-php:8.0 --build-arg IMAGE_PHP_VERSION=8.0 --push .
